...
/*
  Project: Project Anin
  Author: legamuka
 */

var app = {
  init: function init() {
    __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.collapsible').collapsible({
      accordion: false
    });
    __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.parallax').parallax();
  }
};
